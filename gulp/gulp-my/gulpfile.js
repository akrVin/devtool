...
// const cleanFonts = () => {
//   return del(`${paths.buildFonts}/*.ttf`)
// }

const cleanFonts = () => {
  return del(`${paths.resourcesFolder}/fonts/*.ttf`)
}

// const fontsConvert = () => {
//   // looking for font files .otf
//   return src(`${paths.resourcesFolder}/fonts/*.otf`)
...
//     .pipe(src(`${paths.resourcesFolder}/fonts/*.ttf`))
//     .pipe(plumber(notify.onError({
//       title: "FONTS",
//       message: "Error: <%= error.message %>"
//       }))
...
//     // upload to source folder result
...
const resources = () => {
  return src(`${paths.resourcesFolder}/**`, !`${paths.resourcesFolder}/fonts/*.ttf`)
...
exports.default = series(clean, fontsConvert, htmlInclude, scripts, styles, cleanFonts, resources, images, webpImages, svgSprites, watchFiles);
