...
export const ttfToWoff = () => {
  return app.gulp.src(`${app.path.srcFolder}/fonts/*.ttf`, {})
    ...
    .pipe(app.gulp.dest(`${app.path.build.fonts}`))
    .pipe(app.gulp.dest(`${app.path.srcFolder}/fonts/`))
    del(`${app.path.srcFolder}/fonts/*.ttf`)
}

export const delFonts = () => {
  return del(`${app.path.srcFolder}/fonts/*.ttf`);
}

export const fontStyleSCSS = () => {
  let fontsFile = `${app.path.srcFolder}/scss/settings/_fonts.scss`;
