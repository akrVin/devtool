...
import { otfToTtf, ttfToWoff, delFonts, fontStyleSCSS } from "./gulp/tasks/fonts.js";
import { svgSprive } from "./gulp/tasks/svgSprite.js";
import { zip } from "./gulp/tasks/zip.js";
// import { ftp } from './gulp/tasks/ftp.js';

// наблюдатель и изменнение файлов, если нужно смотреть на сервере измения то добавить gulp.series(html, ftp) и раскоментировать сценарий
// вместо html каждую задачу изменить на свою (copy и т.д) тогда все будет выгружаться автоматически
function watcher() {
...
const fonts = gulp.series(otfToTtf, ttfToWoff, delFonts, fontStyleSCSS);
